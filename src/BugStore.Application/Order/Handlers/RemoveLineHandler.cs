...
{
    public class RemoveLineHandler : IRequestHandler<RemoveLineCommand, ResponseOrderDetailedDTO>
    {
        private readonly IOrderWriteRepository _orderWriteRepository;
        private readonly IOrderReadOnlyRepository _orderReadOnlyRepository;
        private readonly IUnitOfWork _unitOfWork;

        public RemoveLineHandler(
        ...
        )
        {
            ...
            var orderLine = order?.Lines.FirstOrDefault(l => l.ProductId == command.ProductId);

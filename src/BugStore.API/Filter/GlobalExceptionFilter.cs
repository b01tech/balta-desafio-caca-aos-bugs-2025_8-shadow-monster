    ...
    public class GlobalExceptionFilter : IExceptionFilter
    {
        ...
        private void HandleCustomException(ExceptionContext context)
        {
            if (context.Exception is OnValidationException)
            {
                ...
                context.Result = new BadRequestObjectResult(new { errors = exception!.ErrorMessages });
            }
            ...
            else if (context.Exception is NotFoundException)
            {
                ...
                context.Result = new NotFoundObjectResult(new { errors = exception!.ErrorMessages });
            }
        }
        ...
        private void HandleUnknownException(ExceptionContext context)
        {
            ...
            context.Result = new ObjectResult(new { error = ResourceExceptionMessage.UNKNOWN_ERROR });
        }
    }
}
